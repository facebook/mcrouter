...
class TestRetainSourceIp(McrouterTestCase):
    config_mc = './mcrouter/test/test_retain_source_ip_mc.json'
    config = './mcrouter/test/test_retain_source_ip_server.json'
    extra_args = ['--retain-source-ip']
