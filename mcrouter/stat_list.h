...
#define GROUP cmd_all_stats | cmd_out_stats | count_stats
  ...
  STUI(cmd_lease_gets_out_count, 0, 1)
  STUI(cmd_lease_gets_out_failover_count, 0, 1)
  STUI(cmd_lease_gets_out_shadow_count, 0, 1)
  STUI(cmd_lease_gets_out_all_count, 0, 1)
...
#define GROUP ods_stats | detailed_stats | cmd_all_stats | cmd_out_stats | \
  ...
  STUIR(cmd_lease_gets_out, 0, 1)
  STUIR(cmd_lease_gets_out_failover, 0, 1)
  STUIR(cmd_lease_gets_out_shadow, 0, 1)
  STUIR(cmd_lease_gets_out_all, 0, 1)
...
#define GROUP cmd_all_stats | cmd_error_stats | count_stats
  ...
  STUI(cmd_lease_gets_local_error_count, 0, 1)
  ...
  STUI(cmd_lease_gets_remote_error_count, 0, 1)
...
#define GROUP ods_stats | detailed_stats | cmd_all_stats | cmd_error_stats | \
  ...
  STUIR(cmd_lease_gets_local_error, 0, 1)
  ...
  STUIR(cmd_lease_gets_remote_error, 0, 1)
