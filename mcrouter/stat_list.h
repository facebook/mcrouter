...
EXTERNAL_STAT(prefix_acl_active_entries_filter_miss)
EXTERNAL_STAT(prefix_acl_auth_deny)
EXTERNAL_STAT(prefix_acl_auth_success)
EXTERNAL_STAT(prefix_acl_checker_config_fetch_failure)
EXTERNAL_STAT(prefix_acl_checker_config_fetch_success)
EXTERNAL_STAT(prefix_acl_checker_created)
EXTERNAL_STAT(prefix_acl_checks)
EXTERNAL_STAT(prefix_acl_configerator_fetch_count)
EXTERNAL_STAT(prefix_acl_dirty_hit)
EXTERNAL_STAT(prefix_acl_match)
EXTERNAL_STAT(prefix_acl_omitted_fetch_count)
EXTERNAL_STAT(prefix_acl_permitted_to_all_hit)
EXTERNAL_STAT(prefix_acl_timeout_fetch_count)
EXTERNAL_STAT(prefix_acl_whitelist_identity_match)
