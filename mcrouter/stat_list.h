...
STUIR(failover_custom_policy_attempts, 0, 1)
...
EXTERNAL_STAT(prefix_acl_whitelist_acl_match)
EXTERNAL_STAT(prefix_acl_whitelist_acl_permitted_to_all)
EXTERNAL_STAT(prefix_acl_whitelist_acl_dirty)
EXTERNAL_STAT(prefix_acl_time_since_init_ms)
EXTERNAL_STAT(prefix_acl_init_duration_ms)
EXTERNAL_STAT(prefix_acl_fetch_count)
EXTERNAL_STAT(prefix_acl_prefix_count)
